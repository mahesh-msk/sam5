...
import com.faiveley.samng.vuetabulaire.ihm.vues.vuefiltre.TabularFiltresEditorTable;
...
public class MoveEditorLineAction extends Action {
	...
	private TabularFiltresEditorTable table;
	
	public MoveEditorLineAction(TabularFiltresEditorTable table, int flag) {
