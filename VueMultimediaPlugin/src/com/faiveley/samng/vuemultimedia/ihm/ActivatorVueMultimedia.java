...
public class ActivatorVueMultimedia extends AbstractActivatorVue {
	...
	public void start(BundleContext context) throws Exception {
        ...
        // Note: On reconstruit ici le chemin vers le bon plugin (c'est � dire vers le fragment correspondant � l'architecture de la machine).
        // Ce chemin d�pend du type d'environnement (DEV ou PROD) mais aussi de l'architecture de l'application
        // Les plugins et fragments ont �t� d�nomm�s de mani�re � d�terminer facilement ces chemins.
        // Le plugin "VueMultimediaPlugin" et le fragment "VueMultimediaPlugin.win32.x86" ne doit en aucun cas �tre renomm� (ou alors uniquement le bloc "VueMultimediaPlugin" pour le plugin et son fragment).
        // Sans quoi les chemins d�termin�s seront faux, la localisation des .dll de VLC ne pourra se faire et la librairie VLCj ne pourra fonctionner.
