 ...
 * */
public class PerspectiveGT implements IPerspectiveFactory {
	/** */
	private static String iD = "SAMNG.perspectiveGT";
...
//		}
		...
		layout.addStandaloneView("SAMNG.Vue.Tabulaire", true, IPageLayout.TOP,tailleTabulaire, editorArea);
