...
IRepereChangedListener {
	...
	/**
	 * Mise � jour de la liste des variables virtuelles dans la vue
	 * 
	 * @param le
	 *            listenner
	 */
	...
	/**
	 * M�thode de r�cup�ration de la liste des variables pouvant �tre
	 * selectionn�es dans la vue des VBVS
	 * 
	 * @return
	 */
	...
	/**
	 * Mise � jour de la liste des variables utilisables pour cr�er des VBV
	 * 
	 * @param le
	 *            listener
	 */
...
//											listeVarFiltres.add(filtreTmp);
	...
	public void saveVbv(VariableVirtuelle vbv, String newVbvName,
		...
		if (vbv != null && firstOperand != null) {
			...
			// v�rification de la validit� des op�randes
			// controle des cycles
...
//		}
	...
	/**
	 * V�rifie la validit� d'une variable virtuelle
	 * @param var
	...
	/**
	 * Affiche un message r�capitulant les VBV en erreur: 
	 * op�randes non valoris�s dans le parcours
