...
public String getText () {
    checkWidget ();
	return text.getItem(0).getText();		//text.getText ();
}
...
public Image getImage () {
    checkWidget ();
	return text.getItem(0).getImage();		//text.getText ();
}
...
void listEvent (Event event) {
    switch (event.type) {
        ...
        case SWT.Selection: {
			...
			Image oldValue = textTblItem.getImage();
			textTblItem.setText(dropTblItem.getText());
			textTblItem.setForeground(dropTblItem.getForeground());
			textTblItem.setImage(dropTblItem.getImage());
...
public void removeAll () {
    checkWidget();
	text.getItem(0).setText("");
	text.getItem(0).setImage((Image)null);
...
public void select (int index) {
    ...
    if (index == -1) {
		...
		textTblItem.setImage((Image)null);
		//text.setText (""); //$NON-NLS-1$
        return;
    }
 ...
 * </ul>
 */
public void setText (String string, Image image) {
    checkWidget();
    if (string == null) SWT.error (SWT.ERROR_NULL_ARGUMENT);
	TableItem textTblItem = text.getItem(0);
    int index = -1;
    ...
    if (index == -1) {
        table.deselectAll ();
		//text.setText (string);
		textTblItem.setText(string);
		textTblItem.setImage(image);
        return;
    }
	textTblItem.setText(string);
	textTblItem.setImage(image);
