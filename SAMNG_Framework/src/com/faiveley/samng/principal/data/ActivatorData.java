...
public class ActivatorData implements Cloneable {
	/* Constante d�finie ici et non pas dans le plugin VueTabulairePlugin, car doit �tre accessible depuis la m�thode notifyDuplicateFiltreListeners */
	...
	/**
	 * M�thode qui averti les fenetre receptrice d'une duplication de filtre
	 * 
	 * @param filtre
	 */
	public synchronized void notifyDuplicateFiltreListeners(List<AFiltreComposant> listeFiltres) {
		 ...
		 * Le cas o� aucun listener n'a �t� enregistr� (liste vide) correspond � une duplication d'un filtre (graphique vers tabulaire). */
		if (this.listenersDuplication.size() == 0) {
			/* La vue filtre tabulaire n'a jamais �t� ouverte pour le fichier courant.
			 * Son ouverture est n�cessaire afin d'instancier l'objet vue qui faut office de listener. */
			...
			/* � pr�sent, un listener a �t� enregistr� et la duplication est possible */
		}
