...
/**
 * Classe de gestion des impression de Sam Peut etre utilis�e pour imprimer les
 * vues, l'ecran etc...
 * 
 * @author Olivier
 * 
...
public class GestionnaireImpression {
	...
	/**
	 * M�thode d'affichage de l'impression
	 * 
	 * @param window
	 */
	...
	/**
	 * M�thode de cr�ation de la structure � imprimer : entete, corps, pied de
	 * page
	 * 
	 * @return
	 */
	...
	/**
	 * M�thode de cr�ation de la structure d'entete
	 * 
	 * @return
	 */
	...
	/**
	 * M�thode de cr�ation de la structure du pied de page
	 * 
	 * @return
	 */
